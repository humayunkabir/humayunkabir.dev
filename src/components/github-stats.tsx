...
export default async function GithubStats() {
  try {
    ...
    return (
      ...
      >
        <div className='absolute inset-0 bg-linear-to-br from-zinc-800/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500' />

        <div className='flex items-center gap-4 relative z-10'>
          <div className='flex items-center justify-center size-12 rounded-full bg-zinc-800 text-zinc-300 group-hover:scale-110 group-hover:text-white transition-all duration-300'>
