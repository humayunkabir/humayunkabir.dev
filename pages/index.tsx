      ...
      <main className='flex flex-col items-center justify-center w-screen min-h-screen py-8 text-center bg-[#14182c] text-white'>
        <div className='max-w-3xl px-8 mx-auto'>
          ...
          <p className='mt-6'>
            ...
            Assistant Lead Engineer building the next-generation Mobile
          ...
          <div className='flex justify-center mt-16 space-x-4'>
            <a
              ...
              rel='noreferrer'
            >
              <Icon name='facebook' className='w-16 h-16' />
            </a>
            <a
              ...
              rel='noreferrer'
            >
              <Icon name='linkedin' className='w-16 h-16' />
            </a>
            <a
              ...
              rel='noreferrer'
            >
              <Icon name='twitter' className='w-16 h-16' />
            </a>
            <a
              ...
              rel='noreferrer'
            >
              <Icon name='github' className='w-16 h-16' />
            </a>
          </div>
        </div>
      </main>
